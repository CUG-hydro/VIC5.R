 ...
 *****************************************************************************/
void compute_pot_evap(size_t model_steps_per_day,
                      double rsmin,
                      double albedo,
                      double shortwave,
                      double net_longwave,
  ...
  ************************************************/
  ...
  Epot_veg = penman(tair, elevation, net_rad, vpd, ra_veg, rc, rarc) /
             model_steps_per_day;

  Epot_soil = penman(tair, elevation, net_rad, vpd, ra_soil, 0.0, param.SOIL_RARC) /
              model_steps_per_day;
